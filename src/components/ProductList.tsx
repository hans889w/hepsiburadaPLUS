...
const ProductList: React.FC = () => {
    ...
    toast.success(
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-green-600 text-sm ml-20"
        >
          Sepete Git
        </button>
      </div>,
  ...
  return (
    <div className="relative p-16 h-[full] mt-[-300px] top-80">
      <div>
        <h3 className="absolute left-15 top-0 text-2xl font-bold mb-6 text-gray-600">
          Sizin için Popüler Ürünlerden Seçtik
        </h3>
              ...
              <Link to={`/product/${product.id}`} key={product.id}>
                <div className="relative bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-sm text-gray-400 line-through">{originalPrice.toFixed(2)} TL</p>
